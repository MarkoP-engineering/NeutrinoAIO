...
The board is still missing several components:

  - Buck/boost converter for battery power
  - External storage in the form of an SD card(?)
  - Connector for the battery
  - Servo driver and the battery power bypass for it
